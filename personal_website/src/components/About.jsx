...
const About = () => {
  return (
    <div className='w-full bg-white py-16 px-4 h-screen mt-24'>
      <div className='max-w-[1240px] mx-auto'>
        <h1 className='text-3xl font-bold mb-8 px-4 text-center' id='About'>ABOUT ME</h1>
        <div className='grid gap-8 md:grid-cols-3'>
          <div className='bg-[#BCB1FF] rounded-lg shadow-xl p-6' style={{transition:'ease-in'}}>
  ...
  <div className='w-[300px] items-center justify-center'>
    ...
    <div className='bg-white p-1 rounded-md mb-3'>
      <p className='text-center'>FIREBASE</p>
          ...
          <div className='bg-[#D4F9B7] rounded-lg shadow-xl p-6'>
            {/*  container 3 */}
